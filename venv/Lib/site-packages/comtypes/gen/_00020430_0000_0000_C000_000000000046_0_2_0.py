...
IFontDisp = Font
__all__ = [ 'Unchecked', 'FONTSTRIKETHROUGH', 'IPictureDisp',
           'OLE_XSIZE_HIMETRIC', 'FONTUNDERSCORE', 'OLE_YPOS_PIXELS',
           'OLE_COLOR', 'OLE_CANCELBOOL', 'OLE_XPOS_CONTAINER',
           'Default', 'FONTNAME', 'OLE_HANDLE', 'IFontEventsDisp',
           'IPicture', 'Gray', 'OLE_ENABLEDEFAULTBOOL', 'FONTITALIC',
           'OLE_OPTEXCLUSIVE', 'Monochrome', 'FONTSIZE', 'StdPicture',
           'OLE_XPOS_PIXELS', 'OLE_YPOS_CONTAINER', 'IFontDisp',
           'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_PIXELS', 'FontEvents',
           'StdFont', 'Checked', 'OLE_YSIZE_HIMETRIC', 'IFont',
           'Font', 'Color', 'OLE_TRISTATE', 'OLE_YPOS_HIMETRIC',
           'OLE_XSIZE_CONTAINER', 'LoadPictureConstants',
           'OLE_XPOS_HIMETRIC', 'VgaColor', 'Picture',
           'OLE_YSIZE_PIXELS', 'FONTBOLD']
